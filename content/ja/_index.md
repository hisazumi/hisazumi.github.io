  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        また、特定の分野に特化した**ドメイン特化言語(Domain-Specific Language; DSL)**の研究も行っています。汎用言語では解決が難しい課題に対し、DSLを用いることで記述量の削減や品質向上を目指します。スマートビルディング・ホーム向けのセキュリティを考慮したDSLや、その安全な実行環境の構築に取り組んでいます。
